        ...
        <div className="home-container">
            ...
            <div className="values-section">
                <div className="values-item">
                    ...
                    <p className={activeIndex === 0 ? 'content active' : 'content'}>At Bloom, we believe in the power of plants to purify and rejuvenate the air in your home. Our carefully selected collection includes species known for their air-cleaning properties, helping you breathe easier and live healthier.</p>
                </div>
                ...
                <div className="values-item">
                    ...
                    <p className={activeIndex === 1 ? 'content active' : 'content'}> Whether you're a seasoned gardener or just starting your plant journey, Bloom offers detailed care guides and support to help your greenery thrive. Our passion for plants extends to educating and inspiring our community, making gardening accessible to all.</p>
                </div>
                ...
                <div className="values-item">
                 <i className="fa-solid fa-leaf"></i>
                    ...
                    <p className={activeIndex === 2 ? 'content active' : 'content'}>We're more than just a store; we're a community dedicated to the environment. Bloom's mission goes beyond commerce, as we strive to spread awareness about the ecological importance of plants. By choosing Bloom, you're joining a movement towards a greener, more beautiful world.</p>
                </div>
            </div>
            ...
            <div className="garden-green-section">
                <div className="green-text-content">
                    <hr className="c-line-after-image" />
                        ...
                        <p className="end-section-home">Dive into our collection and explore detailed care guides to get you flourishing in the world of home gardening - fast.</p>
                    <hr className="c-line-after-image" />
                </div>
